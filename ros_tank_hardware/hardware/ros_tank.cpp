#include "ros_tank_hardware/ros_tank.hpp"
...
{
hardware_interface::CallbackReturn SystemPositionOnlyHardware::on_init(
  const hardware_interface::HardwareInfo & info)
{
  ...
  {
    // SystemPositionOnly has exactly one state and command interface on each joint
    if (joint.command_interfaces.size() != 1)
    {
      RCLCPP_FATAL(
        rclcpp::get_logger("SystemPositionOnlyHardware"),
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("SystemPositionOnlyHardware"), "Successfully configured!");

  return hardware_interface::CallbackReturn::SUCCESS;
}

std::vector<hardware_interface::StateInterface>
SystemPositionOnlyHardware::export_state_interfaces()
{
...
SystemPositionOnlyHardware::export_command_interfaces()
{
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("SystemPositionOnlyHardware"), "Successfully activated!");
...
PLUGINLIB_EXPORT_CLASS(
  ros_tank_hardware::SystemPositionOnlyHardware, hardware_interface::SystemInterface)
